    ...
    return (
        <div className='flex flex-col rounded-2xl overflow-hidden justify-between shadow-lg '>
            ...
            <div className="flex bg-rose-700 justify-center font-semibold">
                <Link to={`/editarcategoria/${categoria.id}`} className="flex justify-center text-white bg-pink-500 border-white border-solid px-4 py-2 hover:bg-rose-200 w-full">
